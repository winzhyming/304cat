<template>
  <div class="dataVisualize-box">
    <div class="card top-box">
      <div class="top-title">访问量汇总统计</div>
        ...
        <el-row :gutter="40">
          ...
          <el-col class="mb40" :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
            <div class="item-center">
              <div class="gitee-traffic traffic-box">
                ...
                <span class="traffic-name sle">小程序 访问量</span>
              </div>
              <div class="gitHub-traffic traffic-box">
                ...
                <span class="item-value">2222</span>
                <span class="traffic-name sle">网站 访问量</span>
              </div>
          ...
          <el-col class="mb40" :xs="24" :sm="24" :md="24" :lg="10" :xl="10">
            <div class="item-right">
              <div class="echarts-title">小程序 / 网站 访问量占比</div>
    ...
    <div class="card bottom-box">
      <!-- <div class="top-title" style="padding-left: 50px">数据来源</div> -->
...
const pieData = [
  { value: 5000, name: "小程序 访问量" },
  { value: 5000, name: "网站 访问量" }
];
const curveData = [
